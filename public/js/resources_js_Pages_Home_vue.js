...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Home",
  components: {
    StatisticComponent: function StatisticComponent() {
      return __webpack_require__.e(/*! import() */ "resources_js_Components_StatisticComponent_vue").then(__webpack_require__.bind(__webpack_require__, /*! ../Components/StatisticComponent */ "./resources/js/Components/StatisticComponent.vue"));
    }
  }
});
...
var render = function () {
  ...
  return _c("div", { staticClass: "container flex flex-wrap items-center" }, [
    _vm._m(0),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "w-full md:w-1/2 space-y-8" },
      [
        _c("h1", { staticClass: "text-4xl font-bold" }, [
          _vm._v("Create your first note!"),
        ]),
        _vm._v(" "),
        _c("p", { staticClass: "text-lg italic" }, [
          _vm._v('Create and save you notes on "Day Note"!'),
        ]),
        _vm._v(" "),
        _c("statistic-component"),
        _vm._v(" "),
        _c(
          "router-link",
          {
            staticClass:
              "inline-flex items-center justify-center h-12 px-8 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-blue-500 hover:bg-blue-700 focus:shadow-outline focus:outline-none",
            attrs: { to: { name: "notes" } },
          },
          [_vm._v("\n            Go to NOTES\n        ")]
        ),
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-full md:w-1/2 my-12" }, [
      _c("img", { attrs: { src: "/screen.svg", alt: "image" } }),
    ])
  },
]
