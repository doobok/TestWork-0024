<nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-full flex-grow flex lg:items-center lg:w-auto mt-2 lg:mt-0 bg-white z-20" id="nav-content">
            <ul class="list-reset flex flex-1 items-center px-4 md:px-0">
                <li class="mr-6 my-2 md:my-0">
                    <a href="{{ route('index') }}" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-orange-600 flex flex-nowrap items-center">
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="{{ route('notes') }}" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500 flex flex-nowrap items-center">
                        ...
                        <span class="pb-1 md:pb-0 text-sm">My Notes</span>
                    </a>
                </li>
            </ul>
